...
-- VARIABLE BIND: año de envío/ejecución (enero del año N)
...
DECLARE
    -------------------------------------------------------------------------
    -- Año de envío/ejecución (bind) y año real de transacciones a procesar
    -------------------------------------------------------------------------
    v_anno_envio    NUMBER := :b_periodo;
    v_periodo       NUMBER := :b_periodo - 1; -- año de transacciones (SBIF: N-1)

    -------------------------------------------------------------------------
    -- VARRAY tipos de transacción a informar
    -------------------------------------------------------------------------
    ...
    -------------------------------------------------------------------------
    -- Variables de cálculo de aporte (en PL/SQL)
    -------------------------------------------------------------------------
    ...
    -------------------------------------------------------------------------
    --  CURSORES EXPLÍCITOS (uno con parámetro)
    -------------------------------------------------------------------------
...
BEGIN
    ...
    -------------------------------------------------------------------------
    --  TRUNCAR TABLAS DE SALIDA EN TIEMPO DE EJECUCIÓN
    -------------------------------------------------------------------------
    ...
    -------------------------------------------------------------------------
    -- COMMIT solo si terminó correctamente y procesó todo
    -------------------------------------------------------------------------
...
/
--------------------------------------------------------------------------------
-- SELECTS DE VALIDACIÓN / EVIDENCIA 
--------------------------------------------------------------------------------
